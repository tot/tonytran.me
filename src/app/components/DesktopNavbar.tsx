...
const DesktopNavbar = ({ links }: DesktopNavbarProps) => {
   ...
   return (
      <nav className="sticky top-10 z-50 mx-auto hidden w-fit items-center justify-between rounded-full border border-neutral-700/75 bg-neutral-800/50 px-2 py-2 shadow-[inset_0px_0.0625rem_0_rgba(255,255,255,0.05),0_0.25rem_0.5rem_0_rgba(0,0,0,0.1)] shadow-md filter backdrop-blur-md md:flex">
