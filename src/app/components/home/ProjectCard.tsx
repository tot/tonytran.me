...
const ProjectCard: FC<ProjectCardProps> = ({
   ...
   return (
      <a href={url} target="_blank">
         <div
            className={cn(
               "relative flex h-full flex-col justify-between rounded-lg border bg-gradient-to-br from-transparent p-4 shadow transition-colors duration-150 hover:bg-neutral-800/25",
               bgColor,
               border
            )}
