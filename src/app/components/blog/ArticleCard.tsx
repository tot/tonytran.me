               ...
               <div className="">
                  <div className="">
                     <div className="relative w-fit">
                        <h2 className="underline-link font-general-sans text-lg font-medium leading-8 tracking-wide text-neutral-200">
                           {title}
                        </h2>
                     </div>
                  ...
                  <div className="flex items-center space-x-1 pt-2">
                     <div className="flex items-center space-x-4 text-neutral-500">
                        <div className="flex w-fit items-center space-x-1 font-sans text-xs font-medium">
