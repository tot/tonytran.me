                ...
                <div className="space-y-2 w-full">
                    <div className="w-full flex flex-col md:flex-row md:items-baseline md:justify-between gap-2">
                        <div className="flex flex-nowrap items-center gap-3">
                            <h3 className="text-base group-hover:bg-[#4de272] group-hover:text-black font-medium flex items-center gap-2 underline underline-offset-2 text-white font-departure tracking-wide">
                                {title}
